    ...
    <div className="max-w-7xl mx-auto px-4 py-6 mt-15">
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_1fr_360px] gap-8">
        ...
        <div className="border border-amber-300 rounded-xl p-5 h-fit sticky top-20 bg-white">
          ...
          <button className="w-full bg-yellow-400 hover:bg-yellow-500 text-black font-medium py-3 rounded-lg mb-3 cursor-pointer">
            Savatchaga
          </button>

          <button className="w-full border border-amber-300 py-3 rounded-lg text-sm">
